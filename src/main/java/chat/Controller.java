...
public class Controller {
    ...
    public long createUser(String username) throws SQLException {
        ...
        return this.getAutogeneratedId(insertUser);
    ...
    public long createChatRoom (long userId, String chatRoomName) throws SQLException {
        ...
        PreparedStatement insertChatroom  = this.conn.prepareStatement(
                "insert into chatrooms (name, createdBy) values (?, ?)", Statement.RETURN_GENERATED_KEYS);

        insertChatroom.setString(1, chatRoomName);
        insertChatroom.setLong(2, userId);
        insertChatroom.executeUpdate();

        return this.getAutogeneratedId(insertChatroom);
    }
    ...
    public void sendMessage (long userId, long chatRoomId, String text) throws SQLException {
        ...
        PreparedStatement insertMessage  = this.conn.prepareStatement(
                "insert into messages (text, chatRoom, createdBy) values (?, ?, ?)");

        insertMessage.setString(1, text);

        insertMessage.setLong(2, chatRoomId);

        insertMessage.setLong(3, userId);
